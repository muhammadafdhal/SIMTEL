        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Rekap Laporan Pembayaran</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="/pembayaran/laporan/pilih_hari" method="post">
                    @csrf
                    <div class="col-md-6">
                        <div class="box-body">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Rekap Laporan Pembayaran pertahun</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form action="/pembayaran/laporan/pilih_tahun" method="post">
                    @csrf
